...
<body>
    ...
    {{-- tinyMCE --}}
    <script src="https://cdn.tiny.cloud/1/281ujfupq4uiuy6odpqklk9866t97b9rg8vzbt58uxgj5yay/tinymce/8/tinymce.min.js"
    ...
    <script>
        ...
        tinymce.init({
            ...
            tinymceai_token_provider: async () => {
                await fetch(
                    `https://demo.api.tiny.cloud/1/281ujfupq4uiuy6odpqklk9866t97b9rg8vzbt58uxgj5yay/auth/random`, {
                        method: "POST",
                        credentials: "include"
                    });
                return {
                    token: await fetch(
                        `https://demo.api.tiny.cloud/1/281ujfupq4uiuy6odpqklk9866t97b9rg8vzbt58uxgj5yay/jwt/tinymceai`, {
                            credentials: "include"
                        }).then(r => r.text())
                };
            },
            uploadcare_public_key: '929e8fa6e336497a5a9a',
        });
    </script>
    @yield('script')
</body>
