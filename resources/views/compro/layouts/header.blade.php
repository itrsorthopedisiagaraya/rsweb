    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
        <div class="container">
            ...
            <div class="logo-wrapper d-flex flex-column justify-content-center align-items-center py-2">
                <a href="{{ route('home') }}"><img src="{{ asset('assets/images/logos/logo.png') }}" width="250"
                        alt="logos"></a>
            </div>
            ...
            <style>
                ...
                .dokter-dropdown ul,
                .postingan-dropdown ul,
                .about-dropdown ul {
                    list-style: none;
                }

                .dokter-dropdown ul li,
                .postingan-dropdown ul li,
                .about-dropdown ul li {
                    padding: 8px 5px;
                }

                .dokter-dropdown ul li a,
                .postingan-dropdown ul li a,
                ...
                <li class="nav-item">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle ml-lg-3" role="button" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                {{ Auth::user()->name }}
                            </a>
