...
<body>
    ...
    <div class="wow zoomIn" id="whatsap-wrapper">
        <img src="{{ asset('assets-compro/assets') }}/img/whatsapp.png" alt="WhatsApp Icon">
    </div>
            ...
            $('#whatsap-wrapper').on('click', function() {
                ...
                if (newWindow) {
                    newWindow.location.href =
                        'https://api.whatsapp.com/send?phone=+628118996586&text=Halo,%20saya%20dapat%20info%20tentang%20RS%20Orthopedi%20Siaga%20Raya%20dari%20website%20www.rsorthopedisiagaraya.id.%20Bisa%20minta%20info%20lebih%20lanjut%3F';
                }
            });
