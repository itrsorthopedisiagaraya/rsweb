                    ...
                    <div class="col-lg-8">
                        <nav aria-label="Breadcrumb">
                            <ol class="breadcrumb bg-transparent py-0 mb-5">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('blog') }}" class="text-primary">Berita</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page"><strong>{{ $item->judul }}</strong>
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="col-6">
                                <ul class="categories">
                                    @foreach ($kategori as $ktgr)
                                        <li><a href="#">{{ $ktgr->kategori }} <span>{{ $ktgr->jml }}</span></a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
