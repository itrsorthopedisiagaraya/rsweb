...
@section('content')
    <div class="page-banner overlay-dark bg-image"
        style="background-image: url({{ asset('') }}assets/images/banner/hospital.jpg);">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="{{ asset('') }}files/gambar_layanan_medis/{{ $data->image }}" alt="gambar_promo"
                                style="width: 100%">
                        </div>
                        <div class="col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body" style="color: #777">
                                    <p class="card-text">Kami hadir dengan teknologi terkini dan tenaga medis berpengalaman.
                                        Rasakan perbedaannya di Rumah Sakit Kami!</p>
                                    <small class="text-muted">Kesehatan Anda adalah prioritas kami.</small>
                                </div>
                            </div>

                            <a class="btn btn-light mt-5 info-promo-btn" target="_blank"
                                href="https://api.whatsapp.com/send?phone=+628118996581">
                                <i class="fab fa-whatsapp"></i>
                                Info Selanjutnya <img src="{{ asset('') }}assets/images/gif/gif-right.gif"
                                    width="20" alt="">
                            </a>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-center align-items-center flex-column">
                ...
                <div class="owl-carousel wow fadeInUp" id="promoSlideshow">
                    ...
                    @foreach ($all_layanan as $item)
                        <div class="item">
                            <a href="{{ route('layananMedis', $item->id) }}" style="text-decoration: none;">
                                <div class="card-promo">
                                    <div class="header">
                                        <img src="{{ asset('') }}files/gambar_layanan_medis/{{ $item->image }}"
                                            alt="">
                                    </div>
