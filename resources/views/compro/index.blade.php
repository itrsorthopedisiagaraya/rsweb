...
@section('content')
        ...
        <div class="dokter-image-wrapper py-5 mt-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <p style="color: #999">Pada Tanggal 18 Juli 2022, Rumah Sakit Siaga Raya resmi berubah nama menjadi RS
                        Orthopedi Siaga Raya. Perubahan nama tersebut juga diikuti dengan perubahan kelas / tipe rumah sakit
                        dari Kelas C Umum menjadi Kelas C Khusus</p>
                ...
                <div class="container">
                    ...
                    <div class="slick-wrapper">
                        ...
                        @foreach ($layanan as $key => $ly)
                            <div class="mx-2">
                                <div class="card card-layanan" data-id="{{ $ly->id }}" id="card-layanan"
                                    style="width: 18rem;">
                                    <img src="{{ asset('') }}files/gambar_layanan/{{ $ly->gambar }}"
                                        class="card-img-top" alt="layanan-image">
                                    <div class="card-body">
                        ...
                        <div class="item">
                            <a href="{{ route('promotion', ['slug' => $item->slug]) }}" style="text-decoration: none;">
                                <div class="card-promo">
                                    <div class="header">
                                        <img src="{{ asset('storage/files/gambar_promo/' . $item->gambar) }}"
                                            alt="">
                                    </div>
                            ...
                            <div class="card-blog">
                                <div class="header">
                                    ...
                                    <a href="{{ url('blog/details', $brt->slug) }}" class="post-thumb">
                                        <img src="{{ asset('storage/files/gambar_postingan/banner/' . $brt->gambar) }}"
                                            alt="">
                                    </a>
                                </div>
                                <div class="body">
                                    <h5 class="post-title"><a
                                            href="{{ url('blog/details', $brt->slug) }}">{{ $brt->judul }}</a></h5>
                                    <div class="site-info">
                        ...
                        <div class="item">
                            <div class="card-doctor">
                                <div class="header">
                                    ...
                                    @else
                                        <img src="{{ asset('') }}files/foto-dokter/{{ $item->foto }}"
                                            alt="doktor">
                                    @endif
                                    <div class="meta d-flex justify-content-center align-items-center">
                                        <a target="_blank" href="https://wa.me/+628118996581"><span
    ...
    <div class="maps-wrapper py-4 bg-light wow fadeInUp bg-light">
        <div class="container">
            <div class="row">
                    ...
                    <div class="label">
                        ...
                        <button type="button" class="btn btn-primary">
                            <svg version="1.1" width="30" height="30"
                                style="background-color:aliceblue; color:aliceblue" x="0px" y="0px" viewBox="0 0 64 64"
                                xml:space="preserve">
                                <path
                                    d="M62.2705,13.6787c-0.3867-1.167-1.2031-2.1118-2.2969-2.6606c0-0.0005-0.001-0.001-0.002-0.001
                    ...
                    <div class="info-address">
                        <div class="jalan">
                            <table>
                                ...
                                <tr style="position: relative;">
                                    <td style="position: absolute; top:0; left:-40px; padding-top: 20px;"><i
                                            class="fa fa-mobile" aria-hidden="true"></i></td>
                                    <td style="padding-top: 20px;">021-7972750</td>
                                </tr>
                                <tr style="position: relative;">
                                    <td style="position: absolute; top:0; left:-40px; padding-top: 20px;"><i
                                            class="fa fa-envelope" aria-hidden="true"></i></td>
                ...
                <div class="col-sm-4">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.930333083982!2d106.83660377515045!3d-6.272891461407162!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f238d2e5070d%3A0xae802229d83eb694!2sJl.%20Siaga%20Raya%20No.4-8%2C%20RT.14%2FRW.3%2C%20Pejaten%20Bar.%2C%20Ps.%20Minggu%2C%20Kota%20Jakarta%20Selatan%2C%20Daerah%20Khusus%20Ibukota%20Jakarta%2012510!5e0!3m2!1sid!2sid!4v1704503411105!5m2!1sid!2sid"
    ...
    {{-- {{ dd($dokter) }} --}}
    <!-- Modal -->
    <div class="modal fade" id="berobat" tabindex="-1" role="dialog" aria-labelledby="berobatLabel"
        aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" id="tgl_periksa" name="tgl_periksa" class="form-control"
                                        disabled>
        ...
        $(document).ready(function() {
            ...
            <span>${days}</span>`
                        ...
                        if (day != null) {
                            ...
                            if (!dayExist) {
                                $('.validate_hari').append(
                                    `<span style="color: red; font-size: 12px;">Dokter tidak ada jadwal hari ${day}</span>`
                                );
            ...
            $('#tgl_periksa').change(function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (!dayExist) {
                            $('.validate_hari').append(
                                `<small style="color: red">Dokter tidak ada jadwal hari ${dayOfWeek}</small>`
                            );
                            $('.daftar').attr('disabled', 'disabled');
                            $('.daftar').css('cursor', 'not-allowed');
                        } else {
