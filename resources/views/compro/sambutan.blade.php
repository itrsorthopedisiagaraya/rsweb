    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="{{ asset('') }}files\gambar_sambutan\DrRinaEditAI.jpg" alt="sambutan" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
